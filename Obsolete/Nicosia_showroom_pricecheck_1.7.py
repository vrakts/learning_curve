...
if os.path.exists(r"K:\SALES\ΧΡΗΣΤΕΣ\PRODUCT 3 - ΓΙΩΡΓΟΣ ΒΡΑΚΑΣ\Script Results") == True :  # does work folder exist?
 ...
 read_path = (r"W:\OneDrive\HTML Parser\Stock")
...
for i in range(1, ac_row):
 ...
 if sheet[i, 0].value != sheet[i-1, 0].value :
  page_url = "https://www.e-shop.cy/product?id=" + sheet[i, 0].value
  # print(page_url)
  ...
  while attempt < 10 :
   try :
    ...
    print("")
    print("")
    print("Aaaah. Cancelled by user. See you next time.")
    sys.exit(0)
   except Exception as exc :
    print("")
    print("Bumped into the following exception: ")
    print(exc)
    print("Trying again.")
    print("")
