...
# Singular website. Will write all values retrieved in an xls file.
#######################
...
write_file = (r"K:\SALES\ΧΡΗΣΤΕΣ\PRODUCT 3 - ΓΙΩΡΓΟΣ ΒΡΑΚΑΣ\Script Results\CY_Singular_Price_Check.xls")  # path to xslx write file
