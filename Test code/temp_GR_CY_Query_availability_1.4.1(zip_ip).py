...
def get_gr_description(page_soup) :
 ...
 if gr_d_soup == None or gr_d_soup.text.find('Σύνολο ψήφων') > 0 or gr_product_table_title.text.strip() != "Περιγραφή" :  # if product_table_body is empty or contains votes or product_table_title doesn't contain Περιγραφή then there is no description
  ...
  if gr_desc_text.find('<b>Εγγύηση') >= 0 :
   if gr_desc_text[gr_desc_text.find('<b>Έγγύηση'):].find('1 χρόνο') > 0 or gr_desc_text.find('1 Χρόνο') > 0 or gr_desc_text.find('1 Χρόνος') > 0 or gr_desc_text.find('1 χρόνος') > 0 or gr_desc_text.find('1 Έτος') > 0 or gr_desc_text.find('1 έτος') > 0 or gr_desc_text.find('2 Χρόνος') > 0 or gr_desc_text.find('2 χρόνος') > 0 or gr_desc_text.find('2 Έτη') > 0 or gr_desc_text.find('2 έτη') or gr_desc_text.find('24 μήνες. ') > 0 or gr_desc_text.find('24 Μήνες.') > 0 :   # if the years are misspelled it is not autocorrected in the CY site. Not looking for "." at the end.
    ...
    gr_desc_text = gr_desc_text.replace('2 έτη', '2 χρόνια')
  if gr_desc_text.find("Ά") > 0 or gr_desc_text.find('face="Constantia" size="3"') > 0 or gr_desc_text.find('size="3" face="Constantia"') > 0 :
