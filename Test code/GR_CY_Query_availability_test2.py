...
query_term = 'πεπα γουρουν'
query_term = query_term.replace(" ", "+")
query_term = quote(query_term.encode('iso-8859-7')).replace('%2B', '+')
...
alt_write_file = ("ALT_GR_CY_Search_Results_" + query_term + ".xls")  # alternate name of xls write file
